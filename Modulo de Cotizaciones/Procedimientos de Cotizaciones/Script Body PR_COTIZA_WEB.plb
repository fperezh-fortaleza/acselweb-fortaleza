...
CURSOR COTI IS
SELECT IdCotiza, TipoId, NumId, DvId, Nombre, Email, Telefono, NroMovil,
...
BEGIN
  FOR P IN COTI LOOP
    ...
    cCodpais        :=P.CodProd; 
    cCodestado      :=P.CodProd; 
    cCodciudad      :=P.CodProd; 
    cCodmunicipio   :=P.CodProd; 
    cDirec          :=P.CodProd; 
