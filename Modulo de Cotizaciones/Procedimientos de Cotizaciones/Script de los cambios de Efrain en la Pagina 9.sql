begin
 if :p9_existe_registro = 'N' then 
    insert into cotizacion
     ...
     select :p9_IdCotiza, codramoplan||codcobert, indcobertoblig,PR_PRE_COBERT.PRE_SUMA(:p9_IdCotiza ,1 ,:p9_producto ,
                   SUBSTR(:p9_plan,1,3) ,SUBSTR(:p9_plan,4,3) ,CodRamoPlan ,
                   CodCobert , PARAMPRECOBERT ,NULL ,
                   NULL,'S')sumaasegmax,                   
                   PR_PRE_COBERT.PRE_TASA(:p9_IdCotiza ,1 ,:p9_producto ,
                   SUBSTR(:p9_plan,1,3) ,SUBSTR(:p9_plan,4,3) ,CodRamoPlan ,
                   CodCobert , PARAMPRECOBERT ,NULL ,
                   NULL,NULL ,NULL ,NULL,'S') tasamax,
                   
                   
                   PR_PRE_COBERT.PRE_SUMA(:p9_IdCotiza ,1 ,:p9_producto ,
                   SUBSTR(:p9_plan,1,3) ,SUBSTR(:p9_plan,4,3) ,CodRamoPlan ,
                   CodCobert , PARAMPRECOBERT ,NULL ,
                   NULL,'S') * PR_PRE_COBERT.PRE_TASA(:p9_IdCotiza ,1 ,:p9_producto ,
                   SUBSTR(:p9_plan,1,3) ,SUBSTR(:p9_plan,4,3) ,CodRamoPlan ,
                   CodCobert , PARAMPRECOBERT ,NULL ,
                   NULL,NULL ,NULL ,NULL,'S') /100 primamax,
     ...
     insert into cotiza_clausula
        select :p9_IdCotiza,cl.codclau, cp.codramo, cp.indclauoblig, :p9_Desde, :p9_Hasta
     ...
     insert into cotizacion_requisito
        select codprod, codplan||revplan, codramoplan, codreq, indoblig, sysdate, 
         ...
         where codplan||revplan = :p9_plan
           and codprod = :p9_producto;
      -- Insertar Endosos / Anexos.
     /*insert into cotizacion_ENDOSO
        select *
          from endoso_ramo_plan_prod
         where codplan||revplan = :p9_plan
           and codprod = :p9_producto;*/
     ...
     update cotizacion
      ...
      delete cotizacion_cobertura where IdCotiza  = :p9_IdCotiza;
